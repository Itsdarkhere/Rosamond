  ...
  return (
    <section className='w-full px-4 sm:px-8 md:px-16 pb-16 flex flex-row justify-center items-center'>
        <div className=" max-w-[1920px] w-full flex flex-row gap-10">
            ...
            <h4 className=' text-white text-2xl font-serif'>Pull Up a Chair & Share Your Dream With Us</h4>
            <p className=' text-white text-lg font-sans'>At Rosamond Construction, we craft homes, cabinetry, and timeless spaces, but our true masterpiece is the enduring bond we forge with you. Share your vision, and together, let's shape dreams into reality.</p>
            </div>
            <form className=' bg-white font-sans shadow-sm rounded-lg flex flex-col justify-start items-start p-4'>
